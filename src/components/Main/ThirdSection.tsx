  ...
  return (
    <View>
      ...
      <Paragraph>
        ...
        voluptatem illum dicta, et suscipit iure itaque!
      </Paragraph>

      <DoCard>
        <CardComponents title="Component recycling" url={Recycling} />

        <CardComponents title="Esprience with computer science" url={Elishir} />

        <CardComponents title="Data storage stack" url={Stack} />
      </DoCard>
    </View>
  );
}
